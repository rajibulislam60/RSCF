            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full p-3 rounded-lg bg-white border text-sm border-gray-200 focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none"
                />
                <input
                  type="email"
                  placeholder="E-mail"
                ...
                <textarea
                  placeholder="Message"
                  rows="{4}"
                  className="w-full p-3 rounded-lg bg-white border text-sm border-gray-200 focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none resize-none"
                  defaultValue={""}
                />
                <button
                  type="button"
                  className="w-full text-sm bg-black/50 hover:bg-black/75 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
                >
                  Send
                </button>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Mirpur, Dhaka</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">+880 01981 869112</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <svg
